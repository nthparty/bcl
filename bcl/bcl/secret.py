...
class SecretBox(encoding.Encodable, StringFixer, object):
    ...
    The ciphertexts generated by :class:`~bcl.secret.Secretbox` include a 16
    ...
    KEY_SIZE = bcl.bindings.crypto_secretbox_KEYBYTES
    NONCE_SIZE = bcl.bindings.crypto_secretbox_NONCEBYTES
    MACBYTES = bcl.bindings.crypto_secretbox_MACBYTES
    MESSAGEBYTES_MAX = bcl.bindings.crypto_secretbox_MESSAGEBYTES_MAX
    ...
    def encrypt(self, plaintext, nonce=None, encoder=encoding.RawEncoder):
        ...
        ciphertext = bcl.bindings.crypto_secretbox(
    ...
    def decrypt(self, ciphertext, nonce=None, encoder=encoding.RawEncoder):
        ...
        plaintext = bcl.bindings.crypto_secretbox_open(
